###Mixing Polygon Simulation (2 isotopes); v1.2, 29.6.2015, R version 3.1.2
...
install.packages("sp")  #for point-in-polygon (P-I-P) calculations
install.packages("splancs") #to calculate polygon area
library(sp)
library(splancs)

##USER INPUT - Gantt Lake
#######################
